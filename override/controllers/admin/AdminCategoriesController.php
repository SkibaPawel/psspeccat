<?php class AdminCategoriesController extends AdminCategoriesControllerCore{
    ...
    {
        parent::init();
        $this->fields_list['specjal'] = array(
                'title' => $this->trans('spec', array(), 'Admin.Global'),
                'active' => 'specjal',
                'type' => 'bool',
    ...
    public function ajaxProcessSpecjalCategory()
    {
        if (!$id_category = (int) Tools::getValue('id_category')) {
            ...
            if (Validate::isLoadedObject($category)) {
                $category->specjal = $category->specjal == 1 ? 0 : 1;
                $category->save() ?
    ...
    public function renderForm()
    {
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->trans('Specjal', array(), 'Admin.Global'),
                    'name' => 'specjal',
                    'required' => false,
                    'is_bool' => true,
                    'hint' => $this->trans('Click on "Displayed" to index the category on your shop.', array(), 'Admin.Catalog.Help'),
